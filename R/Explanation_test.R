...
rules_Server <- function(input, output, session) {
  ...
  taking = "https://raw.githubusercontent.com/BLS33/jaipur/master/images/Taking_Selling_Swapping.png"

  nextplayer = "https://raw.githubusercontent.com/BLS33/jaipur/master/images/NextPlayer.png"
  ...
  output$Next <- renderText({
    c(c('<img src="', nextplayer, '">'))
  })
